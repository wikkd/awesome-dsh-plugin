...
- [wikkd/dsh-remote-access-web](https://github.com/wikkd/dsh-remote-access-web) - Remote access for the DSH browser surface: opens a reverse tunnel so a mobile device can reach a `dsh --profile web` deployment from anywhere, and switches the directory picker to the in-app browse dialog for remote workspace management.
