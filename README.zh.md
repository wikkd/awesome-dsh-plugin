...
- [wikkd/dsh-remote-access-web](https://github.com/wikkd/dsh-remote-access-web) — DSH 浏览器面的远程访问 bundle：在 `dsh-web-app` 上挂载反向隧道 host 插件，并把目录选择器固定为应用内浏览对话框，让远程操作者可以添加工作区。
